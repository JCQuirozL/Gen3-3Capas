<%@ Page Title="Alta de chofer" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AltaChofer.aspx.cs" Inherits="Gen3_3Capas.Catalogos.Choferes.AltaChofer" %>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtApPaterno" CssClass="text-danger" runat="server" ErrorMessage="Apellido de chofer requerido"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group">
