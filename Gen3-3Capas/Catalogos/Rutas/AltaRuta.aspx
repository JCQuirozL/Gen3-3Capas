<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AltaRuta.aspx.cs" Inherits="Gen3_3Capas.Catalogos.Rutas.AltaRuta" %>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="DDLChofer" CssClass="form-control" runat="server" DataValueField="IdChofer" DataTextField="NombreCompleto"></asp:DropDownList>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <ajaxToolkit:AutoCompleteExtender ID="ACtxtOrigen" TargetControlID="txtOrigen" MinimumPrefixLength="2" ServicePath="~/autocomplete.asmx" ServiceMethod="GetDirecciones" runat="server"></ajaxToolkit:AutoCompleteExtender>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="DDLCamion" CssClass="form-control" runat="server" DataValueField="Id" DataTextField="Matricula" OnSelectedIndexChanged="DDLCamion_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <%--funcion de autocompletado--%>
                            <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender1" TargetControlID="txtDestino" MinimumPrefixLength="2" ServicePath="~/autocomplete.asmx" ServiceMethod="GetDirecciones" runat="server"></ajaxToolkit:AutoCompleteExtender>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6" style="padding-bottom: 1rem;">
                                ...
                                <asp:Button ID="btnCancelar" CssClass="btn btn-danger" formnovalidate="" runat="server" Text="Cancelar" />
                            </div>
